 ...
 *
 *  This library is based on a brand new PHP 7.4.3 to work with CodeIgniter 
 *  
 *  @author   Kumar Abhishek <developer@kabhishek18.com> <https://github.com/kabhishek18>
 *  @since    07.04.2020
 *  @license  MIT License
 *  
 *  @version  1.0.4
 *  @link     https://github.com/kabhishek18/
 *
 *  ------------------------------------------------------------------------
 */
